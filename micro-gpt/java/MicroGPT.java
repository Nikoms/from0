...
public class GPT {
    ...
    // Autograd engine for recursive chain rule application
    ...
    // Model hyperparameters for the transformer network
    static int nLayer = 1,
               nEmbd = 16,
               blockSize = 16,
               nHead = 4,
    ...
    // Model architecture: GPT-2 style with rmsnorm instead of
    // layernorm, no biases, and ReLU replacing GeLU
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Adam optimizer setup and training loop
        int nSteps = 1000;
        ...
        // Inference: generating new names from the model
        double temp = 0.5;
        System.out.println(
